# auth-test-clerk-flow
ComfyUI workflow Dockerized via [comfyui-wizard](http://localhost:3939).
Submission: http://localhost:3939/dashboard/submissions/k975yxf5f6aet26rfakpzb0y5185vap3
## Pull the prebuilt image

We've already built and published this image on Docker Hub:

```bash
docker pull timpietruskyrunpod/comfyui-wizard:k975yxf5f6aet26rfakpzb0y5185vap3
docker run --rm --gpus all -p 8188:8188 timpietruskyrunpod/comfyui-wizard:k975yxf5f6aet26rfakpzb0y5185vap3
```
